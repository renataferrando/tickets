...
const AddEventPage = () => {
  ...
  return (
    <Page className="flex justify-center h-[100vh] items-center bg-cover bg-no-repeat bg-right bg-[url('https://res.cloudinary.com/dtvkdwnoa/image/upload/v1735004291/sky-1441936_1280_ot2wen.jpg')]">
